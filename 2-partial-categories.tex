...
%In principle, we could relax the condition that $\{\mathscr{J}_\alpha\}$ is a partition by allowing certain $\mathscr{J}_\alpha$ to be empty, but it will be more convenient to disallow this possibility in the context of this paper.
\end{Rem} 
