...
an rcf $I^{2}$-graded vector space.  A \emph{corepresentation}
 ...
 satisfying 
 \begin{align}
   \label{eq:corep-comultiplication}
    (\Delta_{pq} \otimes
    \id)(\Gr{X}{k}{l}{m}{n}) &=
    \Big{(}\Gr{X}{k}{l}{p}{q}\Big{)}_{13}\Big{(}\Gr{X}{p}{q}{m}{n}\Big{)}_{23},
    \\ \label{eq:corep-counit}
(\epsilon \otimes
...
\begin{Exa} \label{example:corep-regular}
...
\begin{Lem}
  ...
  \eqref{eq:corep-generalized-inverse} hold, then the corresponding
...
\begin{Def} Let $(V,\mathscr{X})$ be an rcf
 ...
 \begin{align} \label{eq:corep-invariant} (1\otimes
...
\end{Lem} 
\begin{proof}
  The sum \eqref{eq:corep-product-blocks} is finite because $V$ and
...
\begin{Prop}
  ...
  $\dual{\mathscr{X}}$ given by
   \begin{align} \label{eq:corep-right-dual}
\Gr{(\dual{X})}{k}{l}{m}{n}   :=  (S \otimes \dual{-})(\Gr{X}{n}{m}{l}{k}) 
   ...
   \begin{align} \label{eq:corep-left-dual}
 ...
 of $\mathscr{A}$ which is a
  ...
  \begin{proof}
    ...
    \eqref{eq:corep-right-dual} belongs to $\Gr{A}{k}{l}{m}{n} \otimes
...
\begin{Prop} 
  ...
  every rcf corepresentation of
  $\mathscr{A}$ decomposes into a direct sum of irreducible rcf
  corepresentations.
\end{Prop} 
\begin{proof} 
...
\begin{Lem} \label{lemma:corep-regular-embedding}
  Let $(V,\mathscr{X})$ be an rcf corepresentation
  of a partial bialgebra and let $v\in
...
Therefore, $f_{-z} = f_{z} \circ S$. Let us now write $\bar{f}_z(a) = \overline{f_z(a^*)}$. Using the preceding calculation,
     ...
     (\Gr{X}{k}{l}{k}{l})^{*}$ and positivity of $\Gru{F_{\mathscr{X}}}{k}{l}$,
     we conclude
     \begin{align*}
       (\bar{f}_z \otimes
       \id)(\Gr{X}{k}{l}{k}{l})
...
& = \left((f_{-z} \otimes \id)(\Gr{X}{k}{l}{k}{l})\right)^{*} 
 =
((\Gru{F_{\mathscr{X}}}{k}{l})^{-z})^{*} 
=       (\Gru{F_{\mathscr{X}}}{k}{l})^{-\overline{z}} = (f_{-\overline{z}}
...
\begin{Def} Let $\mathscr{A}$ define a partial compact quantum group. We call an sfd corepresentation $(V,\mathscr{X})$ on an sfd $I^2$-graded Hilbert space $\mathcal{H}$
