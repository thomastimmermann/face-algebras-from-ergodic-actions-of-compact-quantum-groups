...
Let $\mathscr{A}$ be an $I$-partial bialgebra. An $I^2$-graded Hilbert space $\mathcal{H}=\bigoplus_{k,l} \Gru{\mathcal{H}}{k}{l}$ will be called \emph{locally supported} %better name... 
