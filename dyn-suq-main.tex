...
\begin{abstract}
Hayashi introduced the notion of a compact quantum group of face type, which are actually quantum groupoids with a classical, finite object space. We generalize Hayashi's definition to allow for an infinite-dimensional base algebra. We show how any quantum homogeneous space of an ordinary compact quantum group leads to a compact quantum group of face type. In particular, when this construction is applied to the non-standard Podle\'{s} spheres, which are quantum homogeneous spaces for quantum $SU(2)$, we obtain compact quantum groups of face type which may be seen as operator algebraic versions of the dynamical quantum $SU(2)$-group as studied by Etingof-Varchenko and Koelink-Rosengren.% References ok?
\end{abstract}
