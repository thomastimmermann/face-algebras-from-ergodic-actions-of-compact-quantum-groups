...
% Next theorem still to adapt!
\begin{Theorem} \label{thm:rep-orthogonality} Let $\mathcal{A}$ be a
  partial Hopf algebra with an invariant integral $\phi$. Let $r,s\in I_0$, the hyperobject set, and $I_r,I_s$ the associated subsets of $I$. Let $(V,\mathscr{X})$
...
\begin{Cor} \label{cor:rep-pw-morphisms}
  Let $\mathscr{A}$ be a partial Hopf algebra with an invariant integral, let
  $((V_{\alpha},\mathscr{X}_{\alpha}))_{\alpha}$ be a representative
