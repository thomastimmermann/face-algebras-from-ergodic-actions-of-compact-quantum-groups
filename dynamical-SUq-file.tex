...
In this paper, we investigate the operator algebraic theory of this structure, and introduce in particular two notions of co-amenability. As particular examples, we revisit dynamical quantum $SU(2)$, as studied by Etingof-Varchenko and Koelink-Rosengren, as well as the canonical partial compact quantum group associated to the Temperley-Lieb category. 
...
\emph{Acknowledgements}: Would like to thank E. Koelink and L. Vainerman for discussions.
