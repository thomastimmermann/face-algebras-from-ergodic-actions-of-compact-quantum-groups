...
It turns out that the representation theory of the function algebra on the dynamical quantum $SU(2)$ groups $SU_{q,x}^{\dyn}(2)$ can be completely determined, and in particular one can show that its universal C$^*$-algebra is type $I$. Combined with the results of \cite{KoR1}, this leads to the following theorem.
