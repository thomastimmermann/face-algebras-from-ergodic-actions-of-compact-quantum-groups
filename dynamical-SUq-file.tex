...
\begin{document}
\title{Dynamical quantum $SU(2)$ group on the operator algebra level}
...
\begin{abstract}
\noindent Compact quantum groups of face type, as introduced by T. Hayashi, form a class of quantum groupoids with a classical, finite set of objects. In a previous paper, we generalized Hayashi's definition to allow for an infinite set of objects. The resulting objects were called partial compact quantum groups, and a Tannaka-Krein result for them was proven. In this paper, we apply this Tannaka-Krein result to study the dynamical quantum $SU(2)$-group (as studied by Etingof-Varchenko and Koelink-Rosengren) on the operator algebraic level. 
