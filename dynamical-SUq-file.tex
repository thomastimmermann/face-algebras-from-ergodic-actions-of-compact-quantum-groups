...
\begin{abstract}
\noindent In a previous paper, we generalized Hayashi's theory of compact face algebras to allow for an infinite object set. The resulting structure was called partial compact quantum group. 
In this paper, we investigate the operator algebraic theory of this structure, and introduce in particular two distinct notions of co-amenability. As particular examples, we revisit dynamical quantum $SU(2)$, as studied by Etingof-Varchenko and Koelink-Rosengren, as well as the canonical partial compact quantum group associated to the Temperley-Lieb category. 
...
\emph{Acknowledgements}: We would like to thank E. Koelink and L. Vainerman for discussions.
