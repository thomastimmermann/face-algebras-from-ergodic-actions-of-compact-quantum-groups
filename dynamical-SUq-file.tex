...
Let us come to the precise contents of this paper. In the \emph{first section}, we introduce the notion of C$^*$-algebraic partial compact quantum group, and develop its basic theory. In the \emph{second section}, we make the connection with \cite{DCT1} and \cite{Les1} by showing the relationship between C$^*$-partial compact quantum groups, partial compact quantum groups and measured quantum groupoids. In the \emph{third section}, we show how the dynamical quantum $SU(2)$ group $SU_{q,x}^{\dyn}(2)$ can be seen as a C$^*$-partial compact quantum group, and we classify the representations of its function algebra.
